										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>学生名称:</td>
													<td>
														<input name="name" type="text" class="text" style="width:154px" value="${stu.name}" />
													</td>
												</tr>
												...
												<tr>
													<td>学生密码:</td>
													<td>
														<input class="text" type="text" name="pwd" style="width:154px" value="${stu.pwd}" />
													</td>
												</tr>
												...
												<tr>
													<td>出生日期:</td>
													<td>
														<input class="text" name='birthday' style="width:154px" value="${stu.birthday}" onfocus="WdatePicker()" />
													</td>
												</tr>
												<tr>
													<td>班级:</td>
												...
												<tr>
													<td valign="top">描述:</td>
													<td colspan="3">
														<textarea name="remark" cols="100" rows="8" id = "remark">${stu.remark}</textarea>
													</td>
												</tr>
											</table>
											<br />
